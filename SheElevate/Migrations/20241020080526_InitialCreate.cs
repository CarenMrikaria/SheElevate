        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDOB = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionDetails = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK_Bookings_Mentees_MenteeID",
                        column: x => x.MenteeID,
                        principalTable: "Mentees",
                        principalColumn: "MenteeID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Mentors_MentorsID",
                        column: x => x.MentorsID,
                        principalTable: "Mentors",
                        principalColumn: "MentorsID",
                        onDelete: ReferentialAction.Cascade);
                });
